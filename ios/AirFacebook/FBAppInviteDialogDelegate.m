...
- (void)appInviteDialog:(FBSDKAppInviteDialog *)appInviteDialog didCompleteWithResults:(NSDictionary *)results
{
    ...
    [[AirFacebook sharedInstance] dispatchEvent:[NSString stringWithFormat:@"APPINVITE_SUCCESS_%@", callback] withMessage:resultString];
...
- (void)appInviteDialog:(FBSDKAppInviteDialog *)appInviteDialog didFailWithError:(NSError *)error
{
    ...
    [[AirFacebook sharedInstance] dispatchEvent:[NSString stringWithFormat:@"APPINVITE_ERROR_%@", callback] withMessage:[error description]];
    [[AirFacebook sharedInstance] shareFinishedForCallback:callback];
}
