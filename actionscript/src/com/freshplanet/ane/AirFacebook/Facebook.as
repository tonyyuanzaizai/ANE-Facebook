...
//		}
     ...
     * @param callback (TODO)
     */
    public function gameRequestDialog(gameRequestContent:FBGameRequestContent, callback:Function = null, frictionlessRequestsEnabled:Boolean = true):void
    {
        if (_initialized) {
            ...
            _context.call("gameRequestDialog", gameRequestContent, getNewCallbackName(callback), frictionlessRequestsEnabled );
        } else {
